...
export const collections = [
  ...
  { slug: 'outdoors', title: 'Outdoor Fabrics', description: 'Weather-ready textiles for terraces, balconies and high-use environments.', images: ['outdoor-fabric-geometric.jpeg', 'outdoor-fabric-green.jpeg', 'outdoor-fabric-striped.jpeg'].map(asset) },
];
